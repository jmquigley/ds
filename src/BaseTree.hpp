...
public:
	 ...
	 * Different tree structures may have different algorithms for calculating height,
	 * but all implementations should adhere to the standard definition of tree height.
	 *
	 * Expected behavior:
	 * - Empty trees should return 0
	 * - Trees with only a root node should return 0
	 * - For all other trees, return the longest path length from root to any leaf
	 *
